...
བཏགས་དོན་འཚོལ་བའི་རྣམ་པར་དཔྱོད་པ་མེད་པར་འཇིག་རྟེན་པ་སྟེ་ཐ་སྙད་པའི་ཤེས་པ་རང་དགའ་བ་གནོད་མེད་ཙམ་གྱིས་གྲུབ་པ་ཡིན་པའི་ཕྱིར་དང་།
- Because the way of positing it is that it is established as a mere imputed-existent designated in dependence upon its parts (the wheels, and so forth).
...
Because, in general, it is perceived in the world that when a phenomenon is mentally refuted from being A, then it is determined to be ¬A, and if it is refuted from being ¬A, then it is determined to be A; therefore, one and different are a [[Preliminaries/Collected Topics/mutually negating contradiction#^3dbabb\|mutually-negating direct contradiction]].
...
1. Asserting a self would be meaningless བདག་ཏུ་ཁས་བླངས་པ་དོན་མེད་པ་དང་།
2. The self would become manifold བདག་མང་པོར་འགྱུར་པ་དང་།
3. The self would possess production and disintegration བདག་སྐྱེ་འཇིག་ཅན་དུ་གྱུར་པའོ།
...
- Chapter 18: If it were different from the aggregates, then it would not possess the characteristics of the aggregates. [18.1cd] and
  རབ་བྱེད་བཅོ་བརྒྱད་པ་ལས། གལ་ཏེ་ཕུང་བོ་རྣམས་ལས་གཞན། །ཕུང་པོའ་ིམཚན་ཉིད་མེད་པར་འགྱུར། ཞེས་དང་། 
- Chapter 27: If it were other, then without the appropriated it would be suitable to be apprehended; but it is not. [27.7]
...
---
Up a level: [[Madhyamaka/Presentation of the self as merely dependently designated together with an example (example of the chariot)\|Presentation of the self as merely dependently designated together with an example (example of the chariot)]]