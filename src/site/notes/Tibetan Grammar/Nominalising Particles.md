...
- Same as the [[Tibetan Grammar/Possession Particles\|Possession Particles]]: པ། པོ། བ། བོ། མ། མོ། ཅན། མཁན། ལྡན།
- Plus: བཅས། བྱ། བྱེད། ཚུལ། སྟངས།

Difference with [[Tibetan Grammar/Possession Particles\|Possession Particles]]:
- The possession particles indicate a _person_ as the possessor (sometimes metaphorically) of a noun, adjective or verb
...
Since the collective function of adding the nominalising particles is to put the verb into the [[Tibetan Grammar/The First Case – Nominative\|First Case]], the result is referred to as *nominalised verbs*.
...
**In terms of [[Tibetan Grammar/Adjectives\|adjectives]],** most (but not all) have the པོ་སྒྲ། as part of the root word, for example:
...
**In terms of [[Tibetan Grammar/Nouns\|nouns]],** these nominalising particles are seen as a built in part of the word rather than something that is affixed to them. For example:
...
- These are not considered to have a [[Tibetan Grammar/Possession Particles\|possession particle]] (བདག་སྒྲ།) but to just be part of the word itself.

---
See also: [[Tibetan Grammar/Possession Particles\|Possession Particles]]
