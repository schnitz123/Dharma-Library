...
- The term བྱེད་པ། can refer to Agents in general, i.e. the category which is then divided into Primary and Secondary Agents, while in other cases it is only referring to the latter, e.g. when referring to [[Tibetan Grammar/Part of speech referents\|part of speech referents]].
...
2. because verbs [[Tibetan Grammar/Where agent and object are different\|where agent and object are different]] (ཐ་དད་པ།) must have a བྱེད་པ་པོ།, or
...
- Despite བསྒྲིབས་པ། being a verb [[Tibetan Grammar/Where agent and object are different\|where agent and object are different]] (ཐ་དད་པ།), such verbs require an agent but not necessarily a བྱེད་པ་པོ།. There are many instances of non-persons involved in actions towards (i.e. changing) a separate object.
...
---
Up a level: [[Tibetan Grammar/Tibetan Grammar\|Tibetan Grammar]] / [[Tibetan Grammar/Verbs\|Verbs]]