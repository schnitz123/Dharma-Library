...
Difference with [[Tibetan Grammar/Nominalising Particles\|Nominalising Particles]] (which also use these particles):
...
Please note that the ལྡན་སྒྲ། technically requires a [[Tibetan Grammar/The Dang Particle\|Dang particle]] (དང་སྒྲ།), so these are also abbreviations for བློ་(གྲོས་)དང་ལྡན་པ། and so forth.

---
See: [[Tibetan Grammar/Nominalising Particles\|Nominalising Particles]]
