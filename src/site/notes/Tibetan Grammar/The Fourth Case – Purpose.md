...
- “Bringing water _to_ the field.” ([[Tibetan Grammar/The Second Case – Objective\|Second Case]])
- “Bringing water _for_ the field.” (Fourth Case)
...
- “Bringing water in order to grow barley in the field.” ཞིང་ལ་ནས་སྐྱེ་བའི་ཆེད་དུ་ཆུ་འདྲེན།

Please note that the Ladon now marking the field is the [[Tibetan Grammar/The Seventh Case – Locative\|Seventh Case]], not the Fourth.

**Fourth Case clarifiers:**
- ཆེད་དུ། ཕྱིར་དུ། སླད་དུ། དོན་དུ།
- ཆེད་ལ། ཕྱིར་ལ། དོན་ལ། (སླད་ལ། not used)

These are connected to the verb using a [[Tibetan Grammar/The Sixth Case – Connective\|Sixth Case ]] (see above example) but can be abbreviated as in the second example below.

They can also be connected to nouns, but will still retain the sense of there being an implicit verb. For example:
- བདེ་བའི་ཆེད་དུ།
  Literally “in order for happiness” but implies a verb in relation to that happiness, i.e. “in order to get / have / attain happiness”.
- སེམས་བསྐྱེད་པ་ནི་གཞན་དོན་ཕྱིར། ཡང་དག་རྫོགས་པའི་བྱང་ཆུབ་འདོད།
  “Mind generation is the wish for perfect complete enlightenment for the welfare of others.”
  Here, it implies "in order to enact the welfare of others"

---
**Summary**
- The Fourth Case marks the purpose or benefit of the action, or why that action is being done.
- It will connect verbs with other verbs to create a “doing X in order to do Y” constructions, e.g. ཤིང་གཅོད་དུ་འགྲོ།
- If it is affixed to a noun, then there is an implicit verb relating to that noun and which is the actual purpose.
- For further clarity, the ཆེད། ཕྱིར། སླད། དོན། particles are used.
