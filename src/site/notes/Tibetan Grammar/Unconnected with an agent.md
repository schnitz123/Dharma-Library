...
Mutually inclusive with verbs [[Tibetan Grammar/Where agent and object are not different\|where agent and object are not different]]
Direct opposite of verbs [[Tibetan Grammar/Connected with an agent\|connected with an agent]] / [[Tibetan Grammar/Where agent and object are different\|where agent and object are different]]
