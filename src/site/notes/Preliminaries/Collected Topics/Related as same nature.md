...
**Definition of x being related as one nature with a phenomenon:** 1) x is different from that phenomenon by way of being [[Preliminaries/Collected Topics/One nature\|one nature]] and 2) if that phenomenon does not exist, then x necessarily does not exist.
...
1. being [[Preliminaries/Collected Topics/One nature\|one nature]] with functioning thing;
2. being different from functioning thing;
3. if functioning thing does not exist, then it necessarily does not exist.

---
Up a level: [[Preliminaries/Collected Topics/Contradiction and Relation\|Contradiction and Relation]]