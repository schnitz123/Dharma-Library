---
{"dg-publish":true,"permalink":"/preliminaries/collected-topics/non-implicative-negation/","dg-note-properties":{}}
---
...
2. There does not exist a common locus of:
	1. That which is implicitly conveyed as a cognised-object to its apprehending conception upon the sound expressing it negating its object of negation; and
...
Non-implicative negation and non-implicative other-exclusion are mutually inclusive.

**Divisions:**
1. Non-implicative negation whose object of negation is *possible* among objects of knowledge
...
<br>
2. Non-implicative negation whose object of negation is *impossible* among objects of knowledge
...
**LTK Ocean of Reasoning:** If it is said "The Arya's exalted wisdom of meditative equipoise realises freedom from elaborations that is the mere elimination of elaborations" then they rejoice and are happy, whereas if it is said "It cognises the non-implicative negation of elaborations" they cannot bear it! This is the fault of not understanding that the meaning of non-implicative negation is "the mere elimination of the object of negation" and asserting that all non-implicative negations are complete non-existents like rabbit-horns because if nothing is established then this would contradict that being a non-implicative negation.

---
See also: [[Preliminaries/Collected Topics/Other-exclusions that are non-implicative negations\|Other-exclusions that are non-implicative negations]]
