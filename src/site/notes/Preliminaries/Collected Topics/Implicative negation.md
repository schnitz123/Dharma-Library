...
Other-exclusion that is an implicative negation and implicative negation are mutually inclusive.

**Divisions of other-exclusion that is an implicative negation:**
...
---
**Divisions of implicative negation:**
1. Implicative negation where the sound expressing it *explicitly* conveys the other phenomenon (positive) that is its conveyed-object
...
<br>
1. Implicative negation where the sound expressing it *implicitly* conveys the other phenomenon (positive) that is its conveyed-object
...
<br>
1. Implicative negation where the sound expressing it *both explicitly and implicitly* conveys the other phenomenon (positive) that is its conveyed-object
...
<br>
1. Implicative negation where the sound expressing it *contextually* conveys the other phenomenon (positive) that is its conveyed-object
...
---
See also: [[Preliminaries/Collected Topics/Other-exclusions that are implicative negations\|Other-exclusions that are implicative negations]]
Up a level: [[Preliminaries/Collected Topics/Positive phenomena and Negations\|Positive phenomena and Negations]]